      ...
      <Grid sx={{ width: '100%', textAlign: 'left' }}>
        ...
        <Grid>
          ...
          <Grid columns={[1, 2]}>
            ...
            >
              <Box mb={2}>
                <b>₹12.5 Lakh in Travel Stipends: </b>Epoch is for hackers
                across India and the world; with that in mind, we're providing
                ₹12.5 lakh in travel stipends to both domestic and international
                attendees.
              </Box>
              <Box>
                ...
                stipend recipients outside of India. Travel stipends can be
                requested on the registration form below.
              </Box>
            </Box>
            <Box
              sx={{
            ...
            >
              <Box>
                <Box mb={2}>
                  ...
                  hackers. We’re artists, writers, engineers, tinkerers,
                  campers, filmmakers, volunteers. We make things. We help one
                  another. We have fun.
                </Box>
                <Box>
                  Epoch is fully open source, funded by, and run by the Hack
                  Club community. Hack Clubbers are organising Epoch in public
                  on the
        ...
        <Grid columns={[1, 2]}>
          ...
          <Grid sx={{ height: 'fit-content' }}>
            ...
            <GlossaryItem
              ...
              answer={
                <>
                  Contact us! Reach out on #epoch on the Hack Club Slack or
                  email us at{' '}
                  <a
                    style={{ color: 'black' }}
                    href="mailto:epoch@hackclub.com"
